from GeoTr.extractor import BasicEncoder
from GeoTr.position_encoding import build_position_encoding
...
class GeoTr(nn.Module):
    ...
    def forward(self, image1):
        ...
        bm = (2 * (bm_up / 286.8) - 1) * 0.99
        # bm = (2*(bm_up/288) - 1)
        out = self.unwarp(image1, bm)
